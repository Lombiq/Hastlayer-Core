...
namespace Hast.Remote.Worker.Constants
{
    public static class ConfigurationPaths
    {
        ...
        /// </summary>
        public const string StorageConnectionString = "Hast:Storage_ConnectionString";
        ...
        /// </summary>
        public const string ApplicationInsightsInstrumentationKey = "Hast:ApplicationInsights_InstrumentationKey";
    }
}
