...
{
    /// <summary>
    /// Transforms every available job in the Azure Blob Storage sequentially. If none are available it waits one
    /// second and then retries. It can only be terminated with the <paramref name="cancellationToken"/>.
    /// </summary>
