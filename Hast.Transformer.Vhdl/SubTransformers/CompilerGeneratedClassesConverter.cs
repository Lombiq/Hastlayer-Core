        ...
        public void InlineCompilerGeneratedClasses(SyntaxTree syntaxTree)
        {
            ...
            foreach (var compilerGeneratedClass in compilerGeneratedClasses)
            {
                ...
                if (thisField != null)
                {
                    ...
                    compilerGeneratedClass.AcceptVisitor(new MemberReferenceExpressionVisitingVisitor(memberReferenceExpressionProcessor));
                }
            ...
            // Processing consumer code of DisplayClasses.
            {
                ...
                syntaxTree.AcceptVisitor(new MemberReferenceExpressionVisitingVisitor(memberReferenceExpressionProcessor));
            }
        }
