...
namespace Hast.Transformer.Vhdl.SubTransformers
{
    ...
    public class ExpressionTransformer : IExpressionTransformer
    {
        ...
        //        var reference = identifier.Identifier.ToExtendedVhdlId().ToVhdlVaribleReference();
        ...
        //                context.Scope.StateMachine.Declarations.Add(variable);
        ...
        //    context.TransformationContext.MemberCallChainTable.AddTarget(context.Scope.StateMachine.Name, targetName);
