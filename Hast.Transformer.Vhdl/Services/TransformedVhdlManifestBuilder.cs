...
namespace Hast.Transformer.Vhdl.Services
{
    public class TransformedVhdlManifestBuilder : ITransformedVhdlManifestBuilder
    {
        ...
        public async Task<ITransformedVhdlManifest> BuildManifest(ITransformationContext transformationContext)
        {
            ...
            entity.Declarations.Add(new UnOmittableLineComment("Hast_IP ID: " + Sha2456Helper.ComputeHash(transformationContext.Id)));
            entity.Declarations.Add(new UnOmittableLineComment("Date and time: " + _clock.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + " UTC"));
            entity.Declarations.Add(new UnOmittableLineComment("Generated by Hastlayer - hastlayer.com"));
