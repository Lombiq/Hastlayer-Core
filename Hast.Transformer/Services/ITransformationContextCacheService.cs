...
{
    /// <summary>
    /// Handles caching of the transformed code. When enabled, <see cref="ITransformer"/> may be short-circuited to
    /// jump directly to <see cref="ITransformingEngine"/> using the cached <see cref="ITransformationContext"/>.
    /// </summary>
    public interface ITransformationContextCacheService : IDependency
    {
        ...
        /// <summary>
        /// Retrieves a stored <see cref="ITransformationContext"/> based on the transformation ID and passes it to the
        /// <see cref="ITransformingEngine"/>, if any exists.
        /// </summary>
        /// <returns>
        /// The output of the <see cref="ITransformingEngine.TransformAsync"/> if there is a result,
        ...
        /// <summary>
        /// Stores a <see cref="ITransformationContext"/> that can later be looked up using
        /// <see cref="ITransformationContext.Id"/>.
        /// </summary>
