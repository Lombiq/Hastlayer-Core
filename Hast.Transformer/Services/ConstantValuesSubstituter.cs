    ...
    public class ConstantValuesSubstituter : IConstantValuesSubstituter
    {
        ...
        public void SubstituteConstantValues(SyntaxTree syntaxTree)
        {
            ...
            do
            {
                ...
                syntaxTree.AcceptVisitor(new NonConstantValuesMarkingVisitor(constantValuesTable));
        ...
        private class ConstantValuesMarkingVisitor : DepthFirstAstVisitor
        {
            ...
            public override void VisitPrimitiveExpression(PrimitiveExpression primitiveExpression)
            {
                ...
                {
                    if (!parent.Is<AssignmentExpression>(assignment => assignment.Left.Is<IdentifierExpression>(out identifierExpression)))
                        return false;
        ...
        private class NonConstantValuesMarkingVisitor : DepthFirstAstVisitor
        {
            private readonly ConstantValuesTable _constantValuesTable;


            public NonConstantValuesMarkingVisitor(ConstantValuesTable constantValuesTable)
            {
                _constantValuesTable = constantValuesTable;
            }
            ...
            public override void VisitAssignmentExpression(AssignmentExpression assignmentExpression)
            {
                ...
                // If the value holder is assigned in an if-else or in a loop then it can't safely be a constant.
                if (assignmentExpression.FindFirstParentOfType<IfElseStatement>() != null ||
                    assignmentExpression.FindFirstParentOfType<WhileStatement>() != null)
                {
                    _constantValuesTable.MarkAsNonConstant(assignmentExpression.Left);
                }
            }
        ...
        private class ConstantValuesSubstitutingVisitor : DepthFirstAstVisitor
        {
            ...
            public override void VisitIdentifierExpression(IdentifierExpression identifierExpression)
            {
                ...
                // If this is an identifier on the left side of an assignment then nothing to do.
            ...
            public override void VisitBinaryOperatorExpression(BinaryOperatorExpression binaryOperatorExpression)
            {
                ...
                if (binaryOperatorExpression.FindFirstParentOfType<AttributeSection>() != null) return;
