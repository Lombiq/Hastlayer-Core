...
namespace System
{
    public static class StringExtensions
    {
        ...
        public static bool IsClosureClassName(this string name) => name.Match(@".+\@\d+", RegexOptions.Compiled).Success;
...
#pragma warning restore S103 // Lines should not be too long
        public static bool IsInlineCompilerGeneratedMethodName(this string name) =>
            ...
            name.Match("^.+?::<.+>.+__\\d_\\d\\(", RegexOptions.Compiled).Success;
        ...
        /// </example>
        public static bool IsBackingFieldName(this string name) => name.Match("<(.*)>.*BackingField").Success;
